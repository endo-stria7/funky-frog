/* eslint-disable react/jsx-curly-brace-presence -- replace by number from db */
/* eslint-disable @typescript-eslint/no-useless-template-literals -- replace by number from db */
